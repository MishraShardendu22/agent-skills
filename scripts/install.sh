...
echo "📦 Installing skills-sync from ${REPO}..."
...
echo "✅ skills-sync installed successfully to ${TARGET_BIN}"
...
echo "🚀 Run 'skills-sync --help' or 'skills-sync pull' in any repo to get started!"
